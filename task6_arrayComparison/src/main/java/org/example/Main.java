...
public class Main {
    public static void main(String[] args) {
        ...
        String first_array = Arrays.toString(array1);
        System.out.println("Birinci dizi : " + first_array);

        String second_array = Arrays.toString(array2);
        System.out.println("İkinci dizi : " + second_array);
