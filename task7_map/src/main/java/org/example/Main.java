...
public class Main {
    public static void main(String[] args) {
        ...
        map.put("Şefaat Durmaz","20010101023");
        map.put("Ahmet Metin Ergün","20010101034");
        ...
        boolean key = map.containsKey("Ahmet Metin Ergün");
        System.out.println("Ahmet Metin Ergün haritada var mı : " + key);
